...
// 定数定義
namespace {
	const LPCWSTR g_pszPathTexTitle = L"data/texture/TitleLogo.png";
	const float g_fTexTitleWidth = 800.0f;
	const float g_fTexTitleHeight = 640.0f;
	...
	const LPCWSTR g_pszPathTexBG = L"data/texture/waterillust.png";
}
